...
type LazyRankLogoProps = HTMLAttributes<HTMLSpanElement> & {
  label?: string
...
export const LazyRankLogo = ({
  ...
  return (
    <span className={wrapperClasses} {...props}>
      ...
      {showText && <span className={textClasses}>{label}</span>}
    </span>
  )
}

// Couleur orange principale : #f97316 (orange-500 de Tailwind)
export const LAZYRANK_ORANGE = "#f97316"
