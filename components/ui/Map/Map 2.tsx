...
export const Map = () => {
  return (
    ...
    >
      ...
      >
        Couverture locale à grande échelle, sans effort manuel
      </h2>
      <p className="mt-4 max-w-2xl text-center text-base text-balance text-gray-400 sm:mt-8 sm:text-xl">
        Déployez vos pages locales et vos contenus GEO automatiquement, avec un
        suivi en temps réel des indexations, positions et performances.
      </p>
